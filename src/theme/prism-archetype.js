(function (Prism) {
	...
	Prism.languages.archetype = {
      ...
      inside: {
    	...
    	'type': /\b(?:contract|big_map|map|set|option|list|int|nat|tez|string|rational|bytes|key|key_hash|address|sapling|signature|date|duration|bool|operation|aggregate|partition|asset_view|asset_key|asset_record)\b/,
