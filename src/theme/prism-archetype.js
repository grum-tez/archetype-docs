(function (Prism) {
	...
	Prism.languages.archetype = {
      ...
      inside: {
    	...
    	'builtin': /\b(?:fold|get_entrypoint|reverse|require_entrypoint|exec_lambda|apply_lambda|get_some|is_some|left|right|some|none|isempty|length|put|get|transfer|call|emit|prepend|make_operation)\b/,
    	...
    	'asset': /\b(?:count|sum|asc|desc|remove_if|remove_clear|remove|update|contains|clear|select|sort|head|nth|add|put|add_update|get)\b/,
		'access': /(?:\[|\]|\?|::)/,
