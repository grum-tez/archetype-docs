(function (Prism) {
	...
	Prism.languages.archetype = {
      ...
      inside: {
    	...
    	'builtin': /\b(?:require_entrypoint|exec_lambda|apply_lambda|opt_get|issome|left|right|some|none|isempty|length|put|get|transfer|call|emit|prepend|mkoperation)\b/,
