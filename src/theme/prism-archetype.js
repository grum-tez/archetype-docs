(function (Prism) {
	...
	Prism.languages.archetype = {
      ...
      inside: {
    	...
    	'builtin': /\b(?:get_entrypoint|reverse|require_entrypoint|exec_lambda|apply_lambda|opt_get|issome|left|right|some|none|isempty|length|put|get|transfer|call|emit|prepend|mkoperation)\b/,
    	...
    	'asset': /\b(?:count|sum|asc|desc|removeif|remove|update|contains|clear|select|sort|head|nth|add|put|addupdate|get)\b/,
		'access': /(?:\[|\]|\?|::)/,
