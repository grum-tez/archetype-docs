...
export const types = {
  ...
  conversions : [
    ...
    { label : 'key_hash_to_contract', link : builtin_link_prefix + 'key_hash_to_contract_unit(pkh%20:%20key_hash)', desc: 'Converts a key_hash to contract (without entrypoint)' },
