...
export const instructions = {
    ...
    divergent: [
      ...
      { label : 'dorequire', link : link_prefix + '/divergent#dorequiret-e' },
      { label : 'dofailif', link : link_prefix + '/divergent#dofailift-e' },
    ],
    sets: [
    ...
    assets: [
      ...
      { label : 'addupdate', link : link_prefix + '/asset#aaddupdatek--u-', desc : 'Adds a new asset or updates an asset in collection' },
      { label : 'remove', link : link_prefix + '/asset#aremovek', desc : 'Removes asset from collection' },
      { label : 'removeif', link : link_prefix + '/asset#aremoveifp', desc : 'Removes assets that verify a predicate' },
      { label : 'clear', link : link_prefix + '/asset#aclear', desc : 'Removes all assets from collection' },
      { label : 'removeclear', link : link_prefix + '/asset#aremoveclear', desc : 'Removes all references and referenced assets from aggregate field' },
    ],
    blockchain: [
