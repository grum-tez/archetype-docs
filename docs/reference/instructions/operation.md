...
Indeed operations in the builtin `operations` list are first ordered in the reverse order because of the [`prepend`](/docs/reference/instructions/containers#lprepende) instruction, but the list is [reversed](/docs/reference/expressions/builtins#reverse(l%20:%20list<T>)) when several operations are generated by the entrypoint.
:::
